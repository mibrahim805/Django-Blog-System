...
urlpatterns = [
    ...
    path(
        "post/<int:post_id>/not-interested/",
        not_interested_view,
    ...
    path(
        "profile/<int:user_id>/following/", following_list_view, name="following_list"
    ),
    ...
    path(
        "comment/<int:comment_id>/delete/", comment_delete_view, name="comment_delete"
    ),
